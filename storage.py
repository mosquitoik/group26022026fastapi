...
def transform_book(book: dict) -> BookSavedSchema:
...
class MongoDBStorage:
    def __init__(self):
        ...
        self.collection = db[settings.MONGO_BOOK_COLLECTION]
    ...
    def get_books(self, q: str = "", page: int = 1) -> list[BookSavedSchema]:
        ...
        for book in books:
            saved_books.append(transform_book(book))
